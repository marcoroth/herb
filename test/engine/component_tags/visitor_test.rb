...
module Engine
  module ComponentTags
    class VisitorTest < Minitest::Spec
      ...
      class IconResolver < Herb::Engine::ComponentTags::Resolver
      ...
      def setup
        @visitor = Herb::Engine::ComponentTags::Visitor.new
      end
      ...
      test "component visitor transforms Vue components to ERB" do
        ...
        component_visitor = Herb::Engine::ComponentTags::Visitor.new
      ...
      def custom_resolver_options
        { visitors: [Herb::Engine::ComponentTags::Visitor.new(resolvers: [IconResolver.new])] }
      end
