  ...
  class Engine
    module Slots
      ...
      class Visitor < Herb::Visitor
        ...
        # A fragment's fallback renders once, with the first page that carries the
        # statics container, and the client parks whatever it rendered. That is
        # what makes ERB inside a `<Fallback>` legal, evaluated on the first render
        # and static for the rest of the page's lifetime.
