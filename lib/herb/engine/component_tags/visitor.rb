  ...
  class Engine
    module ComponentTags
      class Visitor < Herb::Visitor
        ...
        experimental "`ComponentTags::Visitor` is experimental. Its output and API may change."

        #: (?resolvers: Array[Herb::Engine::ComponentTags::Resolver]) -> void
        def initialize(resolvers: [ConstantResolver.new, PartialResolver.new])
          super()
        ...
        #: (String) -> Herb::Engine::ComponentTags::Resolver?
