...
static bool extract_escape_content(pm_call_node_t* call_node, const char* handler_name) {
...
static AST_NODE_T* transform_link_to_helper(
  ...
  bool escape_content = extract_escape_content(parse_context->info->call_node, parse_context->matched_handler->name);
