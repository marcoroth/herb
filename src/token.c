...
size_t token_sizeof(void) { return sizeof(struct TOKEN_STRUCT); }
...
const char *token_type_string(int type) {
  ...
  case TOKEN_END_TAG_END:
    return "TOKEN_END_TAG_END";
  ...
  case TOKEN_SPACE:
    return "TOKEN_SPACE";
  case TOKEN_START_TAG_END_VOID:
    return "TOKEN_START_TAG_END_VOID";
  case TOKEN_START_TAG_END:
    return "TOKEN_START_TAG_END";
  case TOKEN_START_TAG_START:
