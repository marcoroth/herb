...
type CheckFunctionsExistInInterface = LibHerbBackendFunctionName extends keyof LibHerbBackendFunctions
  ? true
  : "Error: Not all expectedFunctions are defined in LibHerbBackendFunctions"

type CheckInterfaceKeysInFunctions = keyof LibHerbBackendFunctions extends LibHerbBackendFunctionName
  ? true
...
export function isLibHerbBackend(object: any, libherbpath: string = "unknown"): object is LibHerbBackend {
...
export function ensureLibHerbBackend(object: any, libherbpath: string = "unknown"): LibHerbBackend {
