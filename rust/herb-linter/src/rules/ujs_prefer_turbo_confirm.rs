...
static DESCRIPTOR: LazyLock<UJSAttributeDescriptor> = LazyLock::new(|| UJSAttributeDescriptor {
  ...
  replacement: Some(UJSReplacement {
    attribute: "data-turbo-confirm",
    option: "data: { turbo_confirm: ... }",
  }),
  keyword: None,
});

pub struct UJSPreferTurboConfirmRule;

impl Rule for UJSPreferTurboConfirmRule {
  fn name(&self) -> &'static str {
    "ujs-prefer-turbo-confirm"
  }
...
impl ParserRule for UJSPreferTurboConfirmRule {
