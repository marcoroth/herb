...
static DESCRIPTOR: LazyLock<UJSAttributeDescriptor> = LazyLock::new(|| UJSAttributeDescriptor {
  ...
  keyword: Some(UJSKeyword {
    name: "remote",
    helpers: helper_names_for_tags(&["a", "form"]),
  }),
});

pub struct UJSNoRemoteAttributeRule;

impl Rule for UJSNoRemoteAttributeRule {
  fn name(&self) -> &'static str {
    "ujs-no-remote-attribute"
  }
...
impl ParserRule for UJSNoRemoteAttributeRule {
