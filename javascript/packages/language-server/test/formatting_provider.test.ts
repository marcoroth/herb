...
describe('FormattingProvider', () => {
  ...
  beforeEach(() => {
    ...
    formattingProvider = new FormattingProvider(connection, documents, project, userSettings, {} as Capabilities)
  ...
  describe('formatDocument', () => {
    ...
    it('should handle settings without formatter property', async () => {
      vi.mocked(userSettings.getDocumentSettings).mockResolvedValue({} as any)
