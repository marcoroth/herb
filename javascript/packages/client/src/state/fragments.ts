...
export class Fragments {
  ...
  // A masked fallback must not lose to the state-computed branch while it
  // shows, so the conditional writer asks before flipping.
  ...
  // fallback leaves nothing to watch, so the containing element stands in.
