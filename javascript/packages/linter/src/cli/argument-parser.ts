...
export class ArgumentParser {
  ...
  parse(argv: string[]): ParsedArguments {
    ...
    return { patterns, configFile, formatOption, showTiming, theme, wrapLines, truncateLines, showFixDiff: values["show-fix-diff"] === true, useGitHubActions, fix, fixUnsafe, ignoreDisableComments, force, init, upgrade, disableFailing, loadCustomRules, compareBackends, backend, failOnBackendMismatch, failLevel, logLevel, jobs, only, allRules }
  }
