...
class A11yAriaLevelMustBeValidVisitor extends AttributeVisitorMixin {
...
export class A11yAriaLevelMustBeValidRule extends ParserRule {
  static ruleName = "a11y-aria-level-must-be-valid"
  ...
  check(result: ParseResult, context?: Partial<LintContext>): UnboundLintOffense[] {
    const visitor = new A11yAriaLevelMustBeValidVisitor(this.ruleName, context)
