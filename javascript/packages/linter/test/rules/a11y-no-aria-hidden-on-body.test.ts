...
import { A11yNoAriaHiddenOnBodyRule } from "../../src/rules/a11y-no-aria-hidden-on-body.js"
import { createLinterTest } from "../helpers/linter-test-helper.js"

const { expectNoOffenses, expectWarning, assertOffenses } = createLinterTest(A11yNoAriaHiddenOnBodyRule)

describe("a11y-no-aria-hidden-on-body", () => {
