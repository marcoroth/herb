...
import { A11yNoAriaHiddenOnFocusableRule } from "../../src/rules/a11y-no-aria-hidden-on-focusable.js"
import { createLinterTest } from "../helpers/linter-test-helper.js"

const { expectNoOffenses, expectWarning, assertOffenses } = createLinterTest(A11yNoAriaHiddenOnFocusableRule)

describe("a11y-no-aria-hidden-on-focusable", () => {
