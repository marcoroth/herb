...
const MESSAGE = "Links should go somewhere, you probably want to use a `<button>` instead."
...
describe("html-anchor-require-href", () => {
  ...
  test("passes for a with name attribute and no href", () => {
    expectNoOffenses('<a name="section1"></a>')
  })
