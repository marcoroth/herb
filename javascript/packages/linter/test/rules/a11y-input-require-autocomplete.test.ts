...
import { A11yInputRequireAutocompleteRule } from "../../src/rules/a11y-input-require-autocomplete.js"

const { expectNoOffenses, expectWarning, assertOffenses } = createLinterTest(A11yInputRequireAutocompleteRule)

describe("A11yInputRequireAutocompleteRule", () => {
