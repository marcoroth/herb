...
import { A11yNoNestedLinksRule } from "../../src/rules/a11y-no-nested-links.js"
import { createLinterTest } from "../helpers/linter-test-helper.js"

const { expectNoOffenses, expectError, assertOffenses } = createLinterTest(A11yNoNestedLinksRule)

describe("a11y-no-nested-links", () => {
