...
- [`html-aria-role-must-be-valid`](./html-aria-role-must-be-valid.md) - The `role` attribute must have a valid [WAI-ARIA Role](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Reference/Roles) value.
